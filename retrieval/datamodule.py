...
from common_utils.context import Context, Batch, Example
from common_utils.corpus import Corpus, IndexedCorpus
from common_utils.utils import get_all_pos_premises
...
class RetrievalDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Example:
        ...
        # logger.warning(f'Premises in file: {len(premises_in_file)}')
        # logger.warning(f'Premises outside file: {len(premises_outside_file)}')
        # logger.warning(f'Num in file negatives: {num_in_file_negatives}')
        # logger.warning(f'Num negatives: {self.num_negatives}')
...
class RetrievalDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        logger.warning('train data loader')
        return data_loader
    ...
    def val_dataloader(self) -> DataLoader:
        ...
        logger.warning('val dataloader')
        torch.cuda.memory._dump_snapshot("my_snapshot_val.pickle")
        return data_loader
