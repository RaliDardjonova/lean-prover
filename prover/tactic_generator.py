...
from common_utils.utils import zip_strict, format_augmented_state
...
class HuggingFaceGenerator(TacticGenerator):
    ...
    async def generate(
        ...
        output = self.generator.generate(
            ...
            attention_mask=state_mask, #[:, :self.max_oup_seq_len - 1],
        ...
        t2 = time.time()
        # logger.info(f"Decoding time: {t2 - t1:.2f}s")
        ...
        t3 = time.time() - t2
        # logger.info(f"Postprocessing time for scores: {t3:.2f}s")
